...
import static com.github.edumaxsantos.jlox.TokenType.*;
...
public class Parser {
    ...
    private Expr primary() {
        ...
        if (match(SUPER)) {
            Token keyword = previous();
            consume(DOT, "Expect '.' after a 'super'.");
            Token name = consume(IDENTIFIER, "Expect superclass method/property name.");
